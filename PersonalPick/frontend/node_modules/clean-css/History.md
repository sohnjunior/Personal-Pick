...
* Fixed tests, [package.json](/PersonalPick/frontend/package.json) for development, and regex
...
* Updated repository location and author information in [package.json](/PersonalPick/frontend/package.json).
